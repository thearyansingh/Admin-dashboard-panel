...
const Register = () => {
  ...
  return (
    <div className="max-h-screen  scroll-ignore-none flex items-center justify-center bg-blue-400 px-4 overflow-y-auto">
      <div className="w-full max-w-4xl h-full mt-28 bg-white rounded-xl shadow-md overflow-hidden grid grid-cols-1 md:grid-cols-2">
